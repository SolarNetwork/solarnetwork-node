...
public class FrameMessageImplTests {
	...
	public void getData_basic() {
		// GIVEN
		FrameMessageImpl m = new FrameMessageImpl(MessageType.Frame, MessageType.Frame.getCommand(),
				asList("123", "23.424242", "11", "22", "33", "44"));
