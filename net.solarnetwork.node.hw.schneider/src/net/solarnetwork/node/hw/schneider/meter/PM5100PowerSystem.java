/* ==================================================================
 * PM5100PowerSystem.java - 17/05/2018 6:38:05 PM
 * 
...
public enum PM5100PowerSystem {
	...
	private PM5100PowerSystem(int code, String description) {
		this.code = code;
	 ...
	 */
	public static PM5100PowerSystem forCode(int code) {
		for ( PM5100PowerSystem e : PM5100PowerSystem.values() ) {
			if ( e.code == code ) {
				return e;
			}
		}
