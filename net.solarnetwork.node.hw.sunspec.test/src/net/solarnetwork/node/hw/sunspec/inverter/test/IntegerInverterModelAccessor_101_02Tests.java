...
public class IntegerInverterModelAccessor_101_02Tests {
	...
	public void current() {
		...
		assertThat("Total", model.getCurrent(), equalTo(3.24f));
		assertThat("Phase A", model.accessorForPhase(PhaseA).getCurrent(), equalTo(3.24f));
	...
	public void voltageLN() {
		InverterModelAccessor model = getTestDataInstance().findTypedModel(InverterModelAccessor.class);
		assertThat("Phase A", model.accessorForPhase(PhaseA).getVoltage(), equalTo(247.0f));
		...
		assertThat("Average", (double) model.getVoltage(), closeTo(247.0, 0.01));
	}
	...
	public void activePower() {
		...
		assertThat("Total", model.getActivePower(), equalTo(798));
	}
	...
	public void apparentPower() {
		...
		assertThat("Total", model.getApparentPower(), equalTo(800));
	}
	...
	public void reactivePower() {
		...
		assertThat("Total", model.getReactivePower(), equalTo(56));
	}
	...
	public void powerFactor() {
		...
		assertThat("Average", model.getPowerFactor(), equalTo(0.997f));
	}
	...
	public void activeEnergyExport() {
		...
		assertThat("Total", model.getActiveEnergyExported(), equalTo(76517500L));
	}
	...
	public void dcCurrent() {
		...
		assertThat("Total", model.getDcCurrent(), equalTo(3.35f));
	}
	...
	public void dcVoltage() {
		...
		assertThat("Average", (double) model.getDcVoltage(), closeTo(242.0, 0.01));
	}
	...
	public void dcPower() {
		...
		assertThat("Total", model.getDcPower(), equalTo(810));
	}
