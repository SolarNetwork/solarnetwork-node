...
public class IntegerInverterModelAccessor_103_01Tests {
	...
	public void current() {
		...
		assertThat("Total", model.getCurrent(), equalTo(0.0f));
		assertThat("Phase A", model.accessorForPhase(PhaseA).getCurrent(), equalTo(0.0f));
		assertThat("Phase B", model.accessorForPhase(PhaseB).getCurrent(), equalTo(0.0f));
		assertThat("Phase C", model.accessorForPhase(PhaseC).getCurrent(), equalTo(0.0f));
	}
	...
	public void voltageLN() {
		InverterModelAccessor model = getTestDataInstance().findTypedModel(InverterModelAccessor.class);
		assertThat("Phase A", model.accessorForPhase(PhaseA).getVoltage(), equalTo(283.1f));
		assertThat("Phase B", model.accessorForPhase(PhaseB).getVoltage(), equalTo(283.4f));
		assertThat("Phase C", model.accessorForPhase(PhaseC).getVoltage(), equalTo(279.6f));
		assertThat("Average", (double) model.getVoltage(), closeTo(282.03, 0.01));
	}
	...
	public void apparentPower() {
		...
		assertThat("Total", model.getApparentPower(), equalTo(0));
	}
	...
	public void powerFactor() {
		...
		assertThat("Average", model.getPowerFactor(), equalTo(0.0f));
	}
	...
	public void activeEnergyExport() {
		...
		assertThat("Total", model.getActiveEnergyExported(), equalTo(17129352L));
	}
	...
	public void dcCurrent() {
		...
		assertThat("Total", model.getDcCurrent(), equalTo(0.0f));
	}
	...
	public void dcVoltage() {
		...
		assertThat("Average", (double) model.getDcVoltage(), closeTo(0.0, 0.01));
	}
	...
	public void dcPower() {
		...
		assertThat("Total", model.getDcPower(), equalTo(0));
	}
	...
	public void heatSinkTemperature() {
		InverterModelAccessor model = getTestDataInstance().findTypedModel(InverterModelAccessor.class);
		assertThat("Heat sink temperature", model.getHeatSinkTemperature(), equalTo(0f));
	}
