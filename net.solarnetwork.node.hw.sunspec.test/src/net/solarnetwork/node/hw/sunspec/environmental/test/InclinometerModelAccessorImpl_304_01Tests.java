...
public class InclinometerModelAccessorImpl_304_01Tests {
	...
	public void data() {
		...
		assertThat("Incline 1 x", inc.getInclineX(), is(equalTo(245.82)));
		assertThat("Incline 1 y", inc.getInclineY(), is(equalTo(10.82)));
		assertThat("Incline 1 z", inc.getInclineZ(), is(equalTo(735.98)));
		inc = inclines.get(1);
		assertThat("Incline 2 x", inc.getInclineX(), is(equalTo(12.0)));
		assertThat("Incline 2 y", inc.getInclineY(), is(equalTo(11.82)));
		assertThat("Incline 2 z", inc.getInclineZ(), is(equalTo(3.02)));
	}
