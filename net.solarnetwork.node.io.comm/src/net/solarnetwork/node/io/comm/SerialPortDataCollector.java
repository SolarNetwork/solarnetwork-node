...
implements DataCollector, SerialPortEventListener {
	 ...
	 * @param bufferSize the maximum number of bytes to read at one time
	 * @param magic the "magic" byte sequence to start reading after
	 * @param readSize the desired number of bytes to return
	 * @param maxWait the maximum number of milliseconds to wait for the data 
	 * to be collected
	 */
