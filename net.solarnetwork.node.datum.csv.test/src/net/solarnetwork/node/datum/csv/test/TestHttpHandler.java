...
public abstract class TestHttpHandler extends AbstractHandler {
	...
	protected void respondWithCsv(HttpServletResponse response, String json) throws IOException {
		respondWithContent(response, "test/csv; charset=utf-8", json.getBytes("UTF-8"));
	}

	protected void respondWithCsvResource(HttpServletResponse response, String resource)
			throws IOException {
		respondWithResource(response, resource, "text/csv; charset=utf-8");
	}
