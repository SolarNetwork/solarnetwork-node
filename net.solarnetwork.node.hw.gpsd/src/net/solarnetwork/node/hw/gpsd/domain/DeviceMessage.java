...
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.ACTIVATED_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.BPS_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.CYCLE_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.DRIVER_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.FLAGS_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.MINCYCLE_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.NATIVE_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.PARITY_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.PATH_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.STOPBITS_FIELD;
import static net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.SUBTYPE_FIELD;
...
@JsonSerialize(using = net.solarnetwork.node.hw.gpsd.util.DeviceMessageSerializer.class)
