...
/**
 * This is an API for accessing and storing data from the IBM Weather Company APIs
 * @author matt frost
 *
 */
public interface WCClient {
	 ...
	 */
	Collection<GeneralDayDatum> readDailyForecast(String locationIdentifier, String apiKey, String datumPeriod);
	 ...
	 * @return A collection of {@link GeneralDayDatum} that will be utilized.
	 */
	Collection<WCHourlyDatum> readHourlyForecast(String locationIdentifier, String apiKey, String datumPeriod);
