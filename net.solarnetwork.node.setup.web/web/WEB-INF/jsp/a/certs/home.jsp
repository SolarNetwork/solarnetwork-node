...
<form id="import-cert-modal" class="modal fade" action="<setup:url value='/a/certs/import'/>" method="post" enctype="multipart/form-data">
...
<div id="view-csr-modal" class="modal fade dynamic">
	<div class="modal-dialog">
		<div class="modal-content">
		 	<div class="modal-header">
...
<form id="export-cert-modal" class="modal fade dynamic" action="<setup:url value='/a/certs/nodeCert'/>" method="get">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
...
<form id="renew-cert-modal" class="modal fade dynamic" action="<setup:url value='/a/certs/renew'/>" method="post">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
