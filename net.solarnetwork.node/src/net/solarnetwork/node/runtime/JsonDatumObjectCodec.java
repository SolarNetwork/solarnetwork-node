...
public class JsonDatumObjectCodec extends BaseIdentifiable implements ObjectCodec {
	...
	@Override
	public byte[] encodeAsBytes(Object obj, @Nullable Map<String, ?> parameters) throws IOException {
		return mapper.writeValueAsBytes(obj);
	}

	@Override
	public Object decodeFromBytes(byte[] data, @Nullable Map<String, ?> parameters) throws IOException {
