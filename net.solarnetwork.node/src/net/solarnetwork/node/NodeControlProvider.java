...
public interface NodeControlProvider extends Identifiable {
	 ...
	 * implements {@link net.solarnetwork.node.domain.Datum} then the
	 * {@link net.solarnetwork.node.domain.Datum#DATUM_PROPERTY} event property
	 ...
	 * {@link net.solarnetwork.node.domain.Datum} then the
	 * {@link net.solarnetwork.node.domain.Datum#DATUM_PROPERTY} event property
	 * will be populated with the instance. Otherwise, the properties of the
	 * event shall be any of the JavaBean properties of the NodeControlInfo
	 * supported by events (i.e. any simple Java property such as numbers and
