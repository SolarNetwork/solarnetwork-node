...
public class NodeAppConfiguration {
	 ...
	 */
	public NodeAppConfiguration(@Nullable Map<String, String> networkServiceUrls) {
		super();
		this.created = System.currentTimeMillis();
		this.networkServiceUrls = (networkServiceUrls == null || networkServiceUrls.isEmpty() ? Map.of()
				: Map.copyOf(networkServiceUrls));
	}
