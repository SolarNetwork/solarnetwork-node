...
public class SimpleAcEnergyDatum extends SimpleEnergyDatum implements AcEnergyDatum {
	 ...
	 *        the samples
	 */
	public SimpleAcEnergyDatum(@Nullable String sourceId, @Nullable Instant timestamp,
	 ...
	 *        the samples
	 */
	public SimpleAcEnergyDatum(@Nullable DatumId id, @Nullable DatumSamples samples) {
		super(id, samples);
	}
	...
	@Override
	public SimpleAcEnergyDatum copyWithSamples(@Nullable DatumSamplesOperations samples) {
