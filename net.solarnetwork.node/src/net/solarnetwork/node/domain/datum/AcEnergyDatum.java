...
public interface AcEnergyDatum extends EnergyDatum, net.solarnetwork.domain.datum.AcEnergyDatum {
	 ...
	 */
	default void setRealPower(@Nullable Integer value) {
	 ...
	 *        available
	 */
	default void setApparentPower(@Nullable Integer value) {
	 ...
	 *        not available
	 */
	default void setReactivePower(@Nullable Integer value) {
	 ...
	 */
	default void setPowerFactor(@Nullable Float value) {
	 ...
	 *        the effective power factor
	 */
	default void setEffectivePowerFactor(@Nullable Float value) {
	 ...
	 */
	default void setFrequency(@Nullable Float value) {
	 ...
	 */
	default void setVoltage(@Nullable Float value) {
	 ...
	 *        the volts, or {@code null} if not known
	 */
	default void setVoltage(AcPhase phase, @Nullable Float value) {
	 ...
	 */
	default void setCurrent(@Nullable Float value) {
	 ...
	 *        the phase
	 */
	default void setCurrent(AcPhase phase, @Nullable Float value) {
	 ...
	 *        the amps, or {@code null} if not known
	 */
	default void setNeutralCurrent(@Nullable Float value) {
	 ...
	 *        the volts, or {@code null} if not known
	 */
	default void setPhaseVoltage(@Nullable Float value) {
	 ...
	 */
	default void setLineVoltage(@Nullable Float value) {
	 ...
	 *        the line voltage
	 */
	default void setLineVoltage(AcPhase phase, @Nullable Float value) {
