...
public interface EnergyDatum extends net.solarnetwork.domain.datum.EnergyDatum, MutableNodeDatum {
	 ...
	 */
	default void setWattHourReading(@Nullable Long value) {
	 ...
	 */
	default void setReverseWattHourReading(@Nullable Long value) {
	 ...
	 *        the watts
	 */
	default void setWatts(@Nullable Integer value) {
