...
public interface AtmosphericDatum
	 ...
	 */
	default void setTemperature(@Nullable BigDecimal value) {
	 ...
	 */
	default void setDewPoint(@Nullable BigDecimal value) {
	 ...
	 */
	default void setHumidity(@Nullable Integer value) {
	 ...
	 */
	default void setAtmosphericPressure(@Nullable Integer value) {
	 ...
	 */
	default void setVisibility(@Nullable Integer value) {
	 ...
	 */
	default void setSkyConditions(@Nullable String value) {
	 ...
	 *        the wind speed
	 */
	default void setWindSpeed(@Nullable BigDecimal value) {
	 ...
	 *        the wind direction
	 */
	default void setWindDirection(@Nullable Integer value) {
	 ...
	 *        rain accumulation
	 */
	default void setRain(@Nullable Integer value) {
	 ...
	 *        snow accumulation
	 */
	default void setSnow(@Nullable Integer value) {
	 ...
	 *        irradiance level
	 */
	default void setIrradiance(@Nullable BigDecimal value) {
	 ...
	 */
	default void setCO2(@Nullable BigDecimal value) {
	 ...
	 */
	default void setLux(@Nullable BigDecimal value) {
