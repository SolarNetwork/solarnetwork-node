...
public class SimpleEnergyDatum extends SimpleDatum implements EnergyDatum {
	 ...
	 *        the samples
	 */
	public SimpleEnergyDatum(@Nullable String sourceId, @Nullable Instant timestamp,
	 ...
	 *        the samples
	 */
	public SimpleEnergyDatum(@Nullable DatumId id, @Nullable DatumSamples samples) {
		super(id, samples);
	}
	...
	@Override
	public SimpleEnergyDatum copyWithSamples(@Nullable DatumSamplesOperations samples) {
	...
	@Override
	public SimpleEnergyDatum copyWithId(DatumId id) {
		SimpleEnergyDatum d = new SimpleEnergyDatum(id, getSamples());
