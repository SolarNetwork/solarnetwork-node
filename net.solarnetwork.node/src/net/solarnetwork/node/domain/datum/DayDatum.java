...
public interface DayDatum
	 ...
	 *        the sunrise
	 */
	default void setSunriseTime(@Nullable LocalTime value) {
		asMutableSampleOperations().putSampleValue(Status, SUNRISE_KEY,
				value != null ? DateUtils.format(value) : null);
	}
	 ...
	 *        the sunset
	 */
	default void setSunsetTime(@Nullable LocalTime value) {
		asMutableSampleOperations().putSampleValue(Status, SUNSET_KEY,
				value != null ? DateUtils.format(value) : null);
	}
	 ...
	 *        the moon rise
	 */
	default void setMoonriseTime(@Nullable LocalTime value) {
		asMutableSampleOperations().putSampleValue(Status, MOONRISE_KEY,
				value != null ? DateUtils.format(value) : null);
	}
	 ...
	 *        the moon set
	 */
	default void setMoonsetTime(@Nullable LocalTime value) {
		asMutableSampleOperations().putSampleValue(Status, MOONSET_KEY,
				value != null ? DateUtils.format(value) : null);
	}
	 ...
	 */
	default void setTemperatureMinimum(@Nullable BigDecimal value) {
	 ...
	 */
	default void setTemperatureMaximum(@Nullable BigDecimal value) {
	 ...
	 */
	default void setBriefOverview(@Nullable String value) {
