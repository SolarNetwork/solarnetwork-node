...
public class SimpleDcEnergyDatum extends SimpleEnergyDatum implements DcEnergyDatum {
	 ...
	 *        the samples
	 */
	public SimpleDcEnergyDatum(@Nullable String sourceId, @Nullable Instant timestamp,
	 ...
	 *        the samples
	 */
	public SimpleDcEnergyDatum(@Nullable DatumId id, @Nullable DatumSamples samples) {
		super(id, samples);
	}
	...
	@Override
	public SimpleDcEnergyDatum copyWithSamples(@Nullable DatumSamplesOperations samples) {
