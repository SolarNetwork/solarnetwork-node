...
public interface PluginService {
	 ...
	 *        {@code null} to request all available Plugin instances
	 * @param locale
	 *        an optional locale to apply to PluginInfo
	 * @return list of available plugins, or an empty list if none available
	 */
	List<Plugin> availablePlugins(PluginQuery query, @Nullable Locale locale);
	 ...
	 */
	List<Plugin> installedPlugins(@Nullable Locale locale);
	 ...
	 */
	PluginProvisionStatus removePlugins(Collection<String> uids, @Nullable Locale locale);
	 ...
	 * @return a status object
	 */
	PluginProvisionStatus previewInstallPlugins(Collection<String> uids, @Nullable Locale locale);
	 ...
	 * @return a status object
	 */
	PluginProvisionStatus installPlugins(Collection<String> uids, @Nullable Locale locale);
	 ...
	 * {@code null} even for an ID previously returned.
	 *
	 * @param provisionID
	 *        the provisioning operation ID to find the status for
	 * @param locale
	 *        an optional locale to apply to the returned PluginProvisionStatus
	 * @return the status, or {@code null} if the status is not available
	 */
	PluginProvisionStatus statusForProvisioningOperation(String provisionID, @Nullable Locale locale);
