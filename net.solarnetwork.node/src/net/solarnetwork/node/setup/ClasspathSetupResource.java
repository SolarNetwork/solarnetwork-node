...
public class ClasspathSetupResource extends BaseStaticSetupResource {
	 ...
	 */
	public ClasspathSetupResource(String uid, String path, Class<?> clazz, String contentType,
			@Nullable Set<String> consumerTypes) throws IOException {
	 ...
	 */
	public ClasspathSetupResource(String uid, String path, Class<?> clazz, String contentType,
			@Nullable Set<String> consumerTypes, @Nullable Set<String> roles) throws IOException {
	 ...
	 */
	public ClasspathSetupResource(String uid, String path, Class<?> clazz, String contentType,
			@Nullable Locale locale, int cacheSeconds) throws IOException {
	 ...
	 */
	public ClasspathSetupResource(String uid, String path, Class<?> clazz, String contentType,
			@Nullable Locale locale, int cacheSeconds, @Nullable Set<String> consumerTypes,
			@Nullable Set<String> roles) throws IOException {
	...
	public ClasspathSetupResource(String uid, String path, Class<?> clazz, String contentType,
			@Nullable Locale locale, int cacheSeconds, @Nullable Set<String> consumerTypes,
			@Nullable Set<String> roles, @Nullable SetupResourceScope scope) throws IOException {
