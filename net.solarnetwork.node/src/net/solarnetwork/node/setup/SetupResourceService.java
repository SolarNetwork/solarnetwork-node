...
public interface SetupResourceService {
	 ...
	 */
	@Nullable
	SetupResource getSetupResource(String resourceUID, @Nullable Locale locale);
	 ...
	 */
	Collection<SetupResource> getSetupResourcesForConsumer(String consumerType, @Nullable Locale locale);
