...
public interface OperationalModesService {
	 ...
	 *
	 * <p>
	 * Note that a {@code null} or empty {@code mode} argument will be treated
	 * as testing if the <i>default</i> mode is active, which is always
	 * {@literal true}.
	 * </p>
	 *
	 * @param mode
	 ...
	 * @since 2.0
	 */
	Set<String> enableOperationalModes(Set<String> modes, @Nullable Instant expire);
	 ...
	 * {@link Set}, and it contains {@code mode} or {@code mode} is {@code null}
	 * or empty, then {@literal true} will be returned.
	 * </p>
	 *
	 * @param event
	 ...
	 */
	static boolean hasActiveOperationalMode(@Nullable Event event, @Nullable String mode) {
	 ...
	 * @since 2.0
	 */
	static @Nullable Instant expirationDate(@Nullable Instruction instruction) {
	...
	final class OperationalModeInfo {
		 ...
		 *         if {@code name} is {@code null}
		 */
		public OperationalModeInfo(String name, @Nullable Set<String> tags) {
			super();
