...
public interface PlatformPackageService {
	 ...
	 */
	interface PlatformPackageResult<T extends @Nullable Object> {
	 ...
	 *        {@literal false} to exclude installed packages, or {@code null} to
	 *        include everything
	 ...
	 * @return a future for the package installation results
	 */
	<T> Future<PlatformPackageResult<T>> upgradeNamedPackages(
			@Nullable ProgressListener<T> progressListener, @Nullable T context);
