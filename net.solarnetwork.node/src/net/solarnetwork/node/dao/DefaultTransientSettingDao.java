...
public class DefaultTransientSettingDao extends ConcurrentHashMap<String, ConcurrentMap<String, Object>>
	 ...
	 */
	public final int getSettingsInitialCapacity() {
	 ...
	 *        the capacity to set
	 */
	public final void setSettingsInitialCapacity(int settingsInitialCapacity) {
	 ...
	 */
	public final float getSettingsLoadFactor() {
	 ...
	 */
	public final void setSettingsLoadFactor(float settingsLoadFactor) {
	 ...
	 */
	public final int getSettingsConcurrencyLevel() {
	 ...
	 */
	public final void setSettingsConcurrencyLevel(int settingsConcurrencyLevel) {
