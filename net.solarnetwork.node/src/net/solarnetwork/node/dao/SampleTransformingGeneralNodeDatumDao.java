		...
		if ( datum != null && xformService != null && datum.getSamples() != null ) {
			...
			if ( samples == null || samples.isEmpty() ) {
				...
				log.info("Samples transform service modified datum {} @ {} properties to {}",
						datum.getSourceId(), datum.getCreated(), datum.getSampleData());
				GeneralNodeDatum copy = new GeneralNodeDatum();
				copy.setSourceId(datum.getSourceId());
				copy.setCreated(datum.getCreated());
