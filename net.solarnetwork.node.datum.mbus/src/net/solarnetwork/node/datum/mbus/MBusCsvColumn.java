/* ==================================================================
 * MBusCsvColumn.java - 30/09/2022 11:21:21 am
 * 
...
/**
 * The defined column order for M-Bus Device CSV.
 * 
 * @author matt
 * @version 1.0
 * @since 1.1
 */
public enum MBusCsvColumn implements CodedValue {
	...
	/** The primary M-Bus address (1-255). */
	ADDRESS(6, "Address"),

	/** The maximum sample cache time, in milliseconds. */
	...
	private MBusCsvColumn(int idx, String name) {
		this.idx = idx;
		this.name = name;
	}
	 ...
	 */
	public static final Set<MBusCsvColumn> DEVICE_WIDE_COLUMNS = Collections
			.unmodifiableSet(EnumSet.of(INSTANCE_ID, SERVICE_NAME, SERVICE_GROUP, SOURCE_ID, SCHEDULE,
					NETWORK_NAME, ADDRESS, SAMPLE_CACHE));
