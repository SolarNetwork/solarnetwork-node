...
import static net.solarnetwork.node.io.gpsd.util.ErrorMessageSerializer.MESSAGE_FIELD;
...
@JsonSerialize(using = net.solarnetwork.node.io.gpsd.util.ErrorMessageSerializer.class)
