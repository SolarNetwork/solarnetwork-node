...
public class PositionalDatum extends SimpleDatum {
	 ...
	 *        the source ID
	 */
	public PositionalDatum(ModelData data, @Nullable String sourceId) {
	...
	private static @Nullable Instant dataTimestamp(ModelData data) {
	 ...
	 *        the data
	 */
	public void populateMeasurements(@Nullable GpsModelAccessor data) {
		if ( data == null ) {
			return;
		}
	 ...
	 *        the data
	 */
	public void populateMeasurements(@Nullable InclinometerModelAccessor data) {
		if ( data == null ) {
			return;
		}
	 ...
	 *        the latitude to set
	 */
	public void setLatitude(@Nullable BigDecimal value) {
	 ...
	 */
	public void setLongitude(@Nullable BigDecimal value) {
	 ...
	 */
	public void setElevation(@Nullable BigDecimal value) {
	 ...
	 */
	public void setInclineX(@Nullable Float value) {
	 ...
	 */
	public void setInclineY(@Nullable Float value) {
	 ...
	 */
	public void setInclineZ(@Nullable Float value) {
