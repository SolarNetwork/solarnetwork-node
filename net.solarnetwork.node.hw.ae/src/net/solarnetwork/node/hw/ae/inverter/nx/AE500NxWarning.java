...
/**
 * API for AE500Nx warnings.
 * 
 * @author matt
 * @version 1.0
 * @since 2.1
 */
public interface AE500NxWarning extends GroupedBitmaskable {
	 ...
	 */
	default int getWarningNumber() {
		return (getWarningGroup() * getGroupSize()) + bitmaskBitOffset();
	}

	@Override
	default int getGroupIndex() {
		return getWarningGroup();
	}
