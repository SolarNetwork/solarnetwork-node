/* ==================================================================
 * FeedDataAccessor.java - 7/07/2022 10:22:39 am
 * 
...
/**
 * Data accessor API for feed data.
 * 
 * @author matt
 * @version 1.0
 */
public interface FeedDataAccessor extends AcEnergyDataAccessor {
	...
	/**
	 * Get the total energy capacity of the storage system, in Wh.
	 * 
	 * @return The available energy capacity of the storage.
	 */
	 ...
	 * 
	 * @return the health, as a percentage between 0 and 1
	 */
	Float getStateOfHealthPercentage();
}
