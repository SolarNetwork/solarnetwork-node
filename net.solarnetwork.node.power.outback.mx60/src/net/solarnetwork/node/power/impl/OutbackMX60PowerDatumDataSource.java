 ...
 * 
 * <p>Serial parameters known to work are:</p>
 * 
 * <dl>
 *   <dt>bufferSize</dt>
 *   <dd>64</dt>
 ...
 *   <dd>The {@link DataCollectorFactory} to use to obtain 
 *   {@link DataCollector} instances for reading the Outback MX60 data.</dd>
 * </dl>
 * 
 * @author matt
 * @version $Revision$ $Date$
 */
public class OutbackMX60PowerDatumDataSource
implements DatumDataSource<PowerDatum> {
	 ...
	 * 
	 * <p>The string data format looks like 
	 * {@code D,00,00,00,016,129,00,00,000,00,511,000,000,046}. See the 
	 * <em>Mate Serial Communications Guide</em> for details.</p>
	 * 
	 * @param data the serial data string
