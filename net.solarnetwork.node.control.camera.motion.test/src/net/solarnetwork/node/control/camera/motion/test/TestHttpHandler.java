...
public abstract class TestHttpHandler extends AbstractHandler {
	...
	protected void respondWithText(HttpServletResponse response, String text) throws IOException {
		respondWithContent(response, "text/plain; charset=utf-8", text.getBytes("UTF-8"));
	}
