 ...
 * @version 1.0
 */
public class BacnetDatumDataSourceConfigCsvWriterTests {
	...
	public void writeCsv() throws IOException {
		// GIVEN
		List<Setting> settings = loadSettingsCsv("test-bacnet-settings-01.csv");
		...
		// THEN
		String[] expected = resourceLines("test-bacnet-settings-01-output.csv");
