 ...
 * 
 * <p>An instruction is like a single name (the {@code topic}) with an
 * arbitrary number of named key/value parameters. All parameter names
 * and values are Strings. Each parameter can have any number of
 * associated values.</p>
 * 
 * <p>An Instruction is considered equal to another Instruction only if
 * the {@code instructionId} and {@code instructorId} values are equal.</p>
 * 
 * @author matt
 * @version $Revision$
 */
public interface Instruction {
	...
	/**
	 * Get the unique ID for the sender of the instruction, for example the DN of
	 ...
	 * 
	 * @param parameterName the parameter name to test for
	 * @return <em>true</em> if the parameter name has at least one value available
	 */
	 ...
	 * 
	 * @param parameterName the parameter name to get the value for
	 * @return the first available parameter name, or <em>null</em> if not available
	 */
	 ...
	 * 
	 * @param parameterName the parameter name to get the values for
