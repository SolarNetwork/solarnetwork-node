...
/**
 * Mock implementation of {@link DatumDataSource} for {@link DayDatum}
 * objects.
 * 
 * <p>This simple implementation returns a value for the current day
 * with fixed sunrise/sunset values set according to the {@code timeDayStart}
 * and {@code timeNightStart} properties.</p>
 *
 * <p>The configurable properties of this class are:</p>
 * 
 * <dl class="class-properties">
 *   <dt>timeDayStart</dt>
 *   <dd>The time to use for sunrise. Must be in the form {@code HH:mm}.
 *   Defaults to {@link #DEFAULT_TIME_DAY_START}.</dd>
 *   
 *   <dt>timeNightStart</dt>
 *   <dd>The time to ues for sunset. Must be in the form {@code HH:mm}.
 *   Defaults to  {@link #DEFAULT_TIME_NIGHT_START}.</dd>
 * </dl>
 *
 * @author matt
...
public class MockDayDatumDataSource implements DatumDataSource<DayDatum> {
	...
	/**
	 * @param timeDayStart the timeDayStart to set
	 */
	...
	/**
	 * @param timeNightStart the timeNightStart to set
	 */
