...
public class ModbusDatumDataSourceConfig {
	...
	private @Nullable Integer maxReadWordCount;
	 ...
	 */
	public @Nullable String getModbusNetworkName() {
	 ...
	 */
	public void setModbusNetworkName(@Nullable String modbusNetworkName) {
	 ...
	 */
	public @Nullable Long getSampleCacheMs() {
	 ...
	 */
	public void setSampleCacheMs(@Nullable Long sampleCacheMs) {
	 ...
	 */
	public @Nullable Integer getMaxReadWordCount() {
	 ...
	 */
	public void setMaxReadWordCount(@Nullable Integer maxReadWordCount) {
	 ...
	 */
	public @Nullable ModbusWordOrder getWordOrder() {
		return wordOrder;
	}
	 ...
	 */
	public void setWordOrder(@Nullable ModbusWordOrder wordOrder) {
